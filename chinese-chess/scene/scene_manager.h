...
private:
    ...
    std::shared_ptr<scene_image>    create(std::type_identity<scene_image>,
    ...
    void update_rasterization(std::vector<vk::SemaphoreSubmitInfo>& _pending_waits);
    ...
    void update_ray_tracing(std::vector<vk::SemaphoreSubmitInfo>& _pending_waits);
