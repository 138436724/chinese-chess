...
public:
	...
	[[nodiscard("Staging buffer must be kept!")]] vulkan_buffer create_bottom_level_acceleration_structure(const vk::raii::PhysicalDevice& _physical_device, const vk::raii::Device& _device, const vma::raii::Allocator& _allocator,
	...
	[[nodiscard("Staging buffer must be kept!")]] vulkan_buffer create_top_level_acceleration_structure(const vk::raii::PhysicalDevice& _physical_device, const vk::raii::Device& _device, const vma::raii::Allocator& _allocator,
...
private:
	[[nodiscard("Staging buffer must be kept!")]] vulkan_buffer create_acceleration_structure(const vk::raii::PhysicalDevice& _physical_device, const vk::raii::Device& _device, const vma::raii::Allocator& _allocator,
