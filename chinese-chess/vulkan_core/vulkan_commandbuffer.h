...
public:
	...
	static std::vector<vulkan_commandbuffer> create(const vk::raii::Device& _device, const vk::CommandBufferAllocateInfo& _allocate_info, vulkan_queue* _queue, vulkan_semaphore* _semaphore);
...
private:
	void create(vk::CommandBufferLevel _commandbuffer_level, vk::raii::CommandBuffer&& _commandbuffer, vulkan_queue* _queue, vulkan_semaphore* _semaphore);

private:
	vk::CommandBufferLevel commandbuffer_level = vk::CommandBufferLevel::ePrimary;
	vk::raii::CommandBuffer commandbuffer = nullptr;

	vulkan_queue* queue = nullptr;
