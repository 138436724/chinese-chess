...
std::vector<vulkan_commandbuffer> vulkan_commandbuffer::create(const vk::raii::Device& _device, const vk::CommandBufferAllocateInfo& _allocate_info, vulkan_queue* _queue, vulkan_semaphore* _semaphore)
{
...
void vulkan_commandbuffer::create(vk::CommandBufferLevel _commandbuffer_level, vk::raii::CommandBuffer&& _commandbuffer, vulkan_queue* _queue, vulkan_semaphore* _semaphore)
{
