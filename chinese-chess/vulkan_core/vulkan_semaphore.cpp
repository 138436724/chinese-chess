...
{
	vk::StructureChain<vk::SemaphoreCreateInfo, vk::SemaphoreTypeCreateInfo>create_info(vk::SemaphoreCreateInfo({}), vk::SemaphoreTypeCreateInfo(vk::SemaphoreType::eTimeline, 0));
