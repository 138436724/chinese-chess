...
public:
	...
	inline const static std::unordered_map<UChar, uint8_t> chinese_digits = {
		...
		{u'零', 0}, {u'壹', 1}, {u'贰', 2}, {u'叁', 3}, {u'肆', 4 }, {u'伍', 5},
	...
	inline const static std::unordered_map<UChar, PIECE_TYPE> piece_map = {
		{u'帅', PIECE_TYPE::GENERAL}, {u'帥', PIECE_TYPE::GENERAL}, {u'将', PIECE_TYPE::GENERAL}, {u'將', PIECE_TYPE::GENERAL},
		{u'士', PIECE_TYPE::GUARD}, {u'仕', PIECE_TYPE::GUARD},
		{u'相', PIECE_TYPE::ELEPHANT}, {u'象', PIECE_TYPE::ELEPHANT},
		{u'马', PIECE_TYPE::HORSE}, {u'馬', PIECE_TYPE::HORSE}, {u'傌', PIECE_TYPE::HORSE},
		{u'车', PIECE_TYPE::CHARIOT}, {u'車', PIECE_TYPE::CHARIOT}, {u'俥', PIECE_TYPE::CHARIOT},
		{u'炮', PIECE_TYPE::CANNON}, {u'砲', PIECE_TYPE::CANNON}, {u'炮', PIECE_TYPE::CANNON},
		{u'兵', PIECE_TYPE::PAWN}, {u'卒', PIECE_TYPE::PAWN}
	};
