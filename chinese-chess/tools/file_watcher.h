...
{
public:
    [[nodiscard]] std::string          generate_file_hash(const std::filesystem::path& _file_path) const noexcept;
    [[nodiscard]] bool                 is_file_modified(const std::filesystem::path& _file_path) noexcept;
