...
public:
	...
	void create(const vk::raii::Instance& _instance, const vk::raii::PhysicalDevice& _physical_device,
	...
	const vk::Image get_current_image() const;
	const vk::raii::ImageView& get_current_imageview() const;
	const vk::raii::Semaphore& get_current_waited_semaphore() const;
